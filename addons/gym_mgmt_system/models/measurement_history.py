...
class MeasurementHistory(models.Model):
    ...
    member = fields.Many2one('res.partner', string='Socio', tracking=True,
                             required=True,
    ...
    weight = fields.Float(
        'Peso', digits='Stock Weight', store=True)
    weight_uom_name = fields.Char(string='Etiqueta de unidad de medida de peso',
                                  default=_get_default_weight_uom)
    height = fields.Float(
        'Talla', digits='Stock Height', store=True)
    height_uom_name = fields.Char(string='Etiqueta de unidad de medida de peso',
                                  default='cm')
