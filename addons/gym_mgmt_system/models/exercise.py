...
class GymExercises(models.Model):
    ...
    exercise_for_ids = fields.Many2many("exercise.for", string="Ejercicio Para")
    equipment_ids = fields.Many2one('product.product', string='Equipo',
                                    required=True, tracking=True,
                                    domain="[('gym_product', '!=',False)]")
    note_benefit = fields.Html('Notas')
    note_step = fields.Html('Notas')
    embed_code = fields.Html(compute="_compute_embed_code", sanitize=False)
    video_url = fields.Char('Video URL',
                            help='URL of a video for showcasing your product.')
    image = fields.Binary("Imagen", help="This field holds the image")
    image12 = fields.Binary("Imagen", help="This field holds the image")
    image123 = fields.Binary("Imagen", help="This field holds the image")
    image124 = fields.Binary("Imagen", help="This field holds the image")
